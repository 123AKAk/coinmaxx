...
3. SidebarRight functionality
4. Fullscreen functionality
5. Scrollbar sidebar
6. Popover, tooltip
7. Boostrap menu stay on click
8. Calendar
9. webticker
10. Depth Chart page - SELL/BUY EFFECT
11. select2inputs
...
jQuery(document).ready(function($){
    ...
    var width = $('body').width();
        if(width > 991 && jQuery('#menu_toggle').off('click')) {
            jQuery('.left_col')
                .mouseover( function(){
                    jQuery('body').removeClass("nav-sm");
                    jQuery('body').addClass("nav-md");
                    jQuery('.right_col').css('margin-left ','90px');
                })
                .mouseout( function(){
            ...
            jQuery('#menu_toggle .arrow').on('click', function(){
                jQuery('body').addClass('menu_fix');    
                jQuery('#menu_toggle .close-menu').css('display','block');
                jQuery('#menu_toggle .arrow').css('display','none');
            });
            jQuery('#menu_toggle .close-menu').on('click', function(){
                jQuery('body').removeClass('menu_fix');  
                jQuery('#menu_toggle .close-menu').css('display','none');
                jQuery('#menu_toggle .arrow').css('display','block');
            });
        }  
    
    jQuery('#menu_toggle .burger').on('click', function(){ 
        jQuery('body').removeClass("nav-sm");
        jQuery('body').addClass("nav-md");
        jQuery('.top_nav').addClass('margin-left');
        jQuery('#menu_toggle .close-menu-1').css('display','block');
        jQuery('#menu_toggle .burger').css('display','none');
    });
    jQuery('#menu_toggle .close-menu-1').on('click', function(){ 
        jQuery('body.pace-done').addClass("nav-sm");
        jQuery('body.pace-done').removeClass("nav-md");
        
        jQuery('.top_nav').removeClass('margin-left');
        jQuery('#menu_toggle .close-menu-1').css('display','none');
        jQuery('#menu_toggle .burger').css('display','block');
    });
    $('li').on('click', function(){
        if(jQuery(this).hasClass('active')){
           jQuery('span.fa').removeClass('fa-angle-down');
           jQuery('span.fa').addClass('fa-angle-up');
        }else{
           jQuery('span.fa').removeClass('fa-angle-up');
           jQuery('span.fa').addClass('fa-angle-down');
        }
    });
    ...
    if ($('#data-tables-markets-1').length) {
        jQuery('#data-tables-markets-1').DataTable({
            "pagingType": "full_numbers",
            language: {
                paginate: {
                  next: '&#8250;', // or '>'
    ...
    if ($('#data-tables-markets-1-light').length) {
        jQuery('#data-tables-markets-1-light').DataTable({
            "pagingType": "full_numbers",
            language: {
                paginate: {
                  next: '&#8250;', // or '>'
    ...
    if ($('#data-tables-sell-orders').length) {
        jQuery('#data-tables-sell-orders').DataTable({
            "pagingType": "full_numbers",
            language: {
                paginate: {
                  next: '&#8250;', // or '>'
    ...
    if ($('#data-tables-buy-orders').length) {
        jQuery('#data-tables-buy-orders').DataTable({
            "pagingType": "full_numbers",
            language: {
                paginate: {
                  next: '&#8250;', // or '>'
    ...
    setInterval(function(){ 
        ...
        $('.new-progress-line .progress').fadeIn('2000').css('right','0');  
        setTimeout(function(){
          // toggle back after 1 second
          $('.new-progress-line .progress').fadeOut('100').css('right','57%');  
        },2000);
    },5000);
    /*---------------------------------------------*/
    /*--- 19. Add/Remove row  ---*/
    ...
    $('.add-row').on('click', function () {
        var temp = $(this).closest('tr').clone();
        $('tr:nth-child(3)').after(temp);
    });
