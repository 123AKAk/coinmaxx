...
if(isset($btn)){
    ...
    if (password_verify($pass,$password)) {
        ...
        setcookie('_b_90_s_', $id, time() + (60*60*24*7*31), "/",null,isset($_SERVER["HTTPS"]),true);
        setcookie('_bo___', password_hash('boobs',PASSWORD_DEFAULT), time() + (60*60*24*7*31), "/",null,isset($_SERVER["HTTPS"]),true);
